...
public class InsertCustomBottlePurchaseClass {
...
public static GeneralResponse insertpurchaseitem(InputStream fileInputStream, String userprofileid1, String liquorname, String liquorquantitiy, String parvalue, String category, String shots, String subcategory, String distributorname, String price, String binnumber, String productcode, String minvalue1, String maxvalue1, String type){
			...
			DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
			 ...
			 double minvalue=Double.parseDouble(minvalue1);
				...
				connection=DriverManager.getConnection(Constants.URL,Constants.USER,Constants.PASSWORD);
					...
					try{
						int bottleid=getIdforPicture(userprofileid, liquorname);
						System.out.println("bottle ID: "+bottleid);
						System.out.println("details : "+proid+" / "+liquorname);
